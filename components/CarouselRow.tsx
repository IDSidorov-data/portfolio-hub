  ...
  return (
    <section id={id} className={`mx-auto max-w-6xl px-4 md:px-6 py-10 cv-auto ${className ?? ''}`}>
      ...
      <div className="md:hidden">
        <div className="grid auto-cols-[85%] grid-flow-col gap-4 overflow-x-auto no-scrollbar snap-x snap-mandatory touch-pan-x scroll-px-4 px-4 overscroll-x-contain" role="list" aria-label={title}>
          {items.map((it, i) => (
