        ...
        <div className="p-5 md:p-6">
          ...
          <div className="mt-4">
            <Link
              ...
              className="no-underline inline-flex items-center rounded-xl px-4 py-2 border border-black/10 dark:border-white/10 bg-white/80 dark:bg-white/10 hover:bg-white/90 dark:hover:bg-white/14"
            >
              Обсудить проект
            </Link>
          </div>
