...
export default function CaseHero({
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-white/30 bg-white/70 text-slate-900 shadow-[0_32px_80px_-40px_rgba(15,23,42,0.55)] backdrop-blur-xl dark:border-white/10 dark:bg-white/10 dark:text-white">
