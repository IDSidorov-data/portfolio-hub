...
const palette: CaseVibe[] = [
  {
    ...
    glow: 'bg-gradient-to-br from-rose-200/50 via-orange-100/40 to-amber-200/30 dark:from-rose-500/25 dark:via-orange-500/20 dark:to-amber-500/15',
    halo: 'bg-rose-200/50 dark:bg-rose-500/20',
  },
  {
    emoji: '🚚',
    label: 'Ops',
    surface: 'bg-gradient-to-br from-emerald-100 via-sky-50/80 to-lime-100 dark:from-emerald-500/20 dark:via-sky-500/10 dark:to-lime-500/10',
    ...
    glow: 'bg-gradient-to-br from-emerald-200/45 via-sky-100/40 to-lime-200/35 dark:from-emerald-500/25 dark:via-sky-500/20 dark:to-lime-500/15',
    halo: 'bg-emerald-200/50 dark:bg-emerald-500/25',
  },
  {
    emoji: '🧠',
    label: 'Modeling',
    surface: 'bg-gradient-to-br from-violet-100 via-indigo-50/75 to-sky-100 dark:from-violet-500/20 dark:via-indigo-500/15 dark:to-sky-500/10',
    ...
    glow: 'bg-gradient-to-br from-violet-200/45 via-indigo-100/40 to-sky-200/35 dark:from-violet-500/25 dark:via-indigo-500/20 dark:to-sky-500/15',
    halo: 'bg-violet-200/50 dark:bg-violet-500/25',
  },
  {
    emoji: '🤖',
    label: 'AI',
    surface: 'bg-gradient-to-br from-sky-100 via-indigo-50/75 to-purple-100 dark:from-sky-500/25 dark:via-indigo-600/15 dark:to-purple-600/15',
    shadow: 'shadow-[0_18px_42px_-18px_rgba(56,189,248,0.32)]',
    ...
    glow: 'bg-gradient-to-br from-sky-200/45 via-indigo-100/40 to-purple-200/35 dark:from-sky-500/25 dark:via-indigo-600/20 dark:to-purple-600/15',
    halo: 'bg-sky-200/50 dark:bg-sky-500/25',
  },
  {
    emoji: '🛠️',
    label: 'Automation',
    surface: 'bg-gradient-to-br from-amber-100 via-orange-50/75 to-lime-100 dark:from-amber-500/20 dark:via-orange-500/10 dark:to-lime-500/10',
    ...
    glow: 'bg-gradient-to-br from-amber-200/45 via-orange-100/40 to-lime-200/35 dark:from-amber-500/25 dark:via-orange-500/20 dark:to-lime-500/15',
